 ...
 * @param props 相关属性集合
 * */
function _defineProperties(target:any, props:Array<any>) {
 ...
 * */
function _createClass(Constructor:Function, protoProps:Array<Record<string, any>>, staticProps:Array<Record<string, any>>) {
...
var Person =
  ...
  function () {
    ...
    _createClass(Person, [
      ...
      set: function set(newName:string) {
